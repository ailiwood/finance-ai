...
_extra_hidden = [
  ...
  "src.report",   "src.report.pdf_exporter",   "src.compliance", "src.compliance.disclaimer", "src.compliance.phrase_checker",
  "src.compliance.report_reviewer",
  "src.plugins", "src.plugins.kronos_service",     "src.plugins.kronos_service.gpu_detector", "src.plugins.kronos_service.model_engine",
  "src.plugins.finbert_service",     "src.plugins.finbert_service.sentiment_engine",
